...
, constant c_material_data &material_data [[buffer(15)]])
{
    ...
    constant float& m_focus_centre = material_data.m_focus_centre;
    constant float& m_centre_range = material_data.m_centre_range;
    constant float& m_focus_width = material_data.m_focus_width;
    constant float& m_width_range = material_data.m_width_range;
    ps_output output;
