...
, constant c_per_pass_lights &per_pass_lights [[buffer(11)]]
, constant c_per_pass_shadow &per_pass_shadow [[buffer(12)]]
, constant c_per_pass_shadow_distance_fields &per_pass_shadow_distance_fields [[buffer(13)]]
, constant c_per_pass_area_lights &per_pass_area_lights [[buffer(14)]]
, constant c_material_data &material_data [[buffer(15)]])
{
    ...
    constant float& m_sss_scale = material_data.m_sss_scale;
