...
layout(location = 7) layout(location = 7) in float4 world_matrix_0_instance_input;
layout(location = 8) layout(location = 8) in float4 world_matrix_1_instance_input;
layout(location = 9) layout(location = 9) in float4 world_matrix_2_instance_input;
layout(location = 10) layout(location = 10) in float4 world_matrix_3_instance_input;
layout(location = 11) layout(location = 11) in float4 user_data_instance_input;
layout(location = 12) layout(location = 12) in float4 user_data2_instance_input;
...
void main()
{
    ...
    _output.position /= _output.position.w;
    remap_z_clip_space(_output.position.z);
