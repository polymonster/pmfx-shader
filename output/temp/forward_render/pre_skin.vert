...
layout(location = 0) out float4 vb_position_vs_output;
layout(location = 1) out float4 normal_vs_output;
layout(location = 2) out float4 tangent_vs_output;
layout(location = 3) out float4 bitangent_vs_output;
layout(location = 4) out float4 texcoord_vs_output;
...
void main()
{
    ...
    _output.bitangent = _input.tangent;
